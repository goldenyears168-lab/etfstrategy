...
from research.backtest.archive.c18acc_s2_dual_wma_annot import S2_MIN_HOLD_DAYS, load_c18acc_s2_periods
from research.backtest.archive.c18acc_s2_dual_wma_exit_save import (
    _cohort_label,
    _period_key,
...
def pick_stack_trigger(
    ...
    *,
    ...
    from research.backtest.archive.c18acc_s2_dual_wma_exit_save import _entry_px, _w5_exit_px
