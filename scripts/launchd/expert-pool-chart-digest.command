...
STAMP="$(date '+%Y%m%d')"
LAUNCHD_LOG="${GOLDENSTOCKS_DATA_DIR:-${ROOT}}/logs/launchd_expert-pool-chart-digest.log"
RUN_LOG="${GOLDENSTOCKS_DATA_DIR:-${ROOT}}/logs/expert_pool_chart_digest_${STAMP}.log"
