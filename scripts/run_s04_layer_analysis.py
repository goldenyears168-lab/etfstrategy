    ...
    *,
    ...
    if full_row:
        ...
        if m["n_periods_with_drops"]:
            ...
            lines.append(
                ...
                f"勝台指 {m['dropped_beat_bench_pct']}%"
            )
        ...
        lines.extend(["", "### L2b 逐年勝台指%", "", "| 年 | n | 勝台指% | 均報酬% |", "|----|---|---------|---------|"])
        ...
        lines.extend(
            [
                ...
                "",
                "| 月 | L2b 進場 | n股 | 組合% | 台指% | 超額% | 勝台指 | "
                "L1H9 n | L1H9 勝台指% | L1H9 均報酬% |",
                "|----|----------|-----|-------|-------|-------|--------|"
                "---------|-------------|-------------|",
            ]
        )
    ...
    lines.extend(
        [
            ...
            "- **L2b 完整 s04**：重疊 L1 區間若勝台指 > L1H9，代表動能+品質月頻在短持有下具參考價值。",
