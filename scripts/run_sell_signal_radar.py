#!/usr/bin/env python3
"""Sell signal radar · universe extension advisory · no holdings overlay."""
...
from strategy_signal_radar import print_sell_radar_log, run_sell_signal_radar, write_radar_report

_TZ = ZoneInfo("Asia/Taipei")


def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Sell signal radar · extension advisory")
    ...
    p.add_argument("--no-dedup", action="store_true", help="Do not mark dedup writes")
    return p.parse_args()
