#!/usr/bin/env python3
"""Fubon Neo API 連線測試（Execution layer smoke test）。

請用 Python 3.13 專用 venv：
  .venv-fubon/bin/python scripts/execution/fubon_login_test.py [--realtime] [--snapshot]
"""
...
from execution.fubon_session import account_label, check_python_version, connect_fubon  # noqa: E402
...
def main() -> int:
    ...
    if args.snapshot:
        from execution.fubon_account import account_snapshot
